...
extern class Three
{
	...
	static var OBJLoader2 : Dynamic;
	static var STLLoader : Dynamic;
	...
	static function warn(message:Dynamic, optionalParams:Dynamic) : Void;
	static function error(message:Dynamic, optionalParams:Dynamic) : Void;
	static function log(message:Dynamic, optionalParams:Dynamic) : Void;
}